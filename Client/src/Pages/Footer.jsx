...
function Footer() {
  return (
    <section className="relative max-w-sm w-full p-8 bg-[#020202] mt-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-14 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-500">
          <div className="w-full max-lg:mx-auto flex flex-col gap-6">
            <div className="flex flex-col items-center justify-center">
              <h6 className="text-xl font-medium text-white mb-7 max-lg:text-center">
                Xperiento
              </h6>
